/* Implemente um método na classe ListaDinamica que una esta lista a outra lista recebida como parâmetro.
public void unir (ListaDinamica lista);
Considere que a lista recebida será colocada no final da lista cujo método foi chamado; */
...
//	Remover
	...
	public void unir (Lista Lista2) {
		while(!(Lista2.isEmpty())) {
			this.add(Lista2.inicio.dado);
			lista2.remove(0);
		}
